<template>
    ...
    <div
        class=" bg-gray-light dark:bg-darkMode-gray-light p-12 w-full md:w-11/12 m-auto rounded-md flex flex-col items-center text-center">
        ...
        <form class=" grid grid-cols-1 w-full gap-4 min-[850px]:grid-cols-2 min-[1149px]:px-[135px]"
            ...
            <div class=" gap-4 min-[850px]:gap-0 min-[850px]:col-span-2 flex flex-col min-[850px]:flex-row">
                <textarea placeholder="Enter your message" v-model="formData.message" type="text"
                    class=" w-full m-auto sm:w-[335px] min-[850px]:w-[462px] min-h-14 h-fit rounded-[55px] border-[1.4px] active:border-green-dark border-green-dark text-green-dark text-center pt-4"></textarea>
                <button :disabled="loading" type="submit"
                    class=" m-auto relative w-full sm:w-[335px] min-[850px]:w-[213px] h-14 border border-green-dark rounded-[55px] shadow-sm focus:outline-none focus:border-green text-center text-white bg-green transition duration-300 hover:bg-green-dark">
...
const title = "Do you have a Complaint?"
