    ...
    <div
        ...
        <form class=" grid grid-cols-1 w-full gap-4 min-[850px]:grid-cols-2 min-[1149px]:px-[135px]"
            ...
            <div class=" gap-4 min-[850px]:gap-0 min-[850px]:col-span-2 flex flex-col min-[850px]:flex-row">
                <button
                    class="m-auto relative w-full sm:w-[335px] min-[850px]:w-[462px] h-14 border border-green-dark rounded-[55px] shadow-sm focus:outline-none focus:border-green text-center text-white bg-green transition duration-300 hover:bg-green-dark">
                    <p class=" gap-4 flex justify-center items-center"><span>Upload Your CV</span><font-awesome-icon
                            icon="angle-up" /></p>
                </button>

                <button :disabled="loading" type="submit"
                    class=" sm:w-[335px] m-auto relative w-full min-[850px]:w-[213px] h-14 border border-green-dark rounded-[55px] shadow-sm focus:outline-none focus:border-green text-center text-white bg-green transition duration-300 hover:bg-green-dark">
