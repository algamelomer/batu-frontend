<template>
  <div
    class="flex flex-col justify-center items-center w-fit font-Mulish"
    v-visible="visibilityChanged"
  >
    <h1
      class="text-green-dark text-center font-bold text-3xl sm:text-4xl"
      :class="titleClasses, styles,ask"
      @animationend="onAnimationEnd"
    >
      {{ title }}
    </h1>
    <hr width="50px" class="border-black border-[1.5px] mt-5" :class="ask"/>
  </div>
</template>
