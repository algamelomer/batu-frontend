<template>
    <BaseHeaderImage :title="baseTitle" :subtitle="baseSubtitle" imgPath="/src/assets/aboutUs.png" />
    <div class=" flex flex-col md:px-10 px-0 mt-10 gap-10">
        ...
        <BaseContainer class="mx-5">
            ...
            <ListTile v-for="doctor in doctorsDummyData" :name="doctor.name" :major="doctor.major"
                :imgPath="doctor.imgPath" :onClick="doctor.onClick" class="mb-5 mt-5" />
        </BaseContainer>
        <!-- politics -->
            ...
            <ul class=" gap-2 flex flex-col list-disc mt-20">
                <template v-for="item in politics" :key="item.id">
                    <li class=" flex w-fit items-center">
                        <span class=" w-2 h-2 rounded-full bg-gray-dark mr-2"></span>
                        <BaseSubtitle :subtitle="item.title" class=" w-fit h-min mt-0 mb-0 mx-0"
                            text_styles="!mb-0 !mt-0" />
                        <span class="text-gray-400 px-2"> : </span>
                        <BaseSubtitle :subtitle="item.subtitle" class=" w-fit h-min mt-0 mb-0 mx-0"
                            text_styles="!mb-0 !mt-0" />
                    </li>
                </template>
            </ul>
        ...
        <ask_universty_president class=" md:w-11/12 w-full m-auto" />
    </div>
</template>
...
import ask_universty_president from './components/ask_universty_president.vue';
import CardGrid from "@components/CardGrid.vue";
import BaseContainer from "@components/BaseContainer.vue";
import ListTile from "../facultyStaff/components/ListTile.vue";
import { useRouter } from 'vue-router'

const baseTitle = ref("About University");
const baseSubtitle = ref("Discover our mission, values, and commitment to excellence. Learn about our team, history, and vision for the future.");
...
const dummyCards = [
    {
        iconPath: '/src/assets/icons/Vector (1).svg',
        title: 'Students Affairs',
        onclick: () => router.push('/soon'),
    },
    {
        iconPath: 'src/assets/icons/Vector (2).svg',
        title: 'Secretary General of the University',
        onclick: () => router.push('/soon'),
    },
    {
        iconPath: 'src/assets/icons/Vector (3).svg',
...
const doctorsDummyData = [
    {
        ...
        imgPath: "/src/assets/5c62856ecd0d05ce0a3152961e49fdc9.png",
    },
    {
        name: "Organizer",
        major: "Organizer Description",
